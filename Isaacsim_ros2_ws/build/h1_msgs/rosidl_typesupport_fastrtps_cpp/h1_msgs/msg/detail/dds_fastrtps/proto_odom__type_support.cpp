...
#include "h1_msgs/msg/detail/proto_odom__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = h1_msgs::msg::ProtoOdom;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const h1_msgs::msg::ProtoOdom *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<h1_msgs::msg::ProtoOdom *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _ProtoOdom__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const h1_msgs::msg::ProtoOdom *>(
...
static size_t _ProtoOdom__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_ProtoOdom(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _ProtoOdom__callbacks = {
  "h1_msgs::msg",
  "ProtoOdom",
...
static rosidl_message_type_support_t _ProtoOdom__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_ProtoOdom__callbacks,
...
template<>
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_EXPORT_h1_msgs
const rosidl_message_type_support_t *
get_message_type_support_handle<h1_msgs::msg::ProtoOdom>()
{
  return &h1_msgs::msg::typesupport_fastrtps_cpp::_ProtoOdom__handle;
}
