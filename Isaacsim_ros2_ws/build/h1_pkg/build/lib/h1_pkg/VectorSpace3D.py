...
class cartesian_vector(vector3D):
    ...
    def get_ros2_geometry_msgs_vector3(self, ros2_vector3):
        '''
        the function takes any "geometry_msgs.msg.Vector3" to create an inference.
        '''
        msg = deepcopy(ros2_vector3)
        msg.x, msg.y, msg.z = self.get()
        return msg
